<?php get_header() ?>
    ...
    <div class="breadcrumb">
      ...
      <div class="breadcrumb__item"><a href="">Blog</a></div>
      <div class="breadcrumb__item breadcrumb__item--last"><a href="">Tour de Poncol Jilid 2</a></div>
    </div>
    <div class="page">
      <div class="page__wrapper">
        ...
        <div class="page__content-main">
          ...
          <div class="page__comment-box">.page__comment-box</div>
        </div>
      </div>
    </div>
